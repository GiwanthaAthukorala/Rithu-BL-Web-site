      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-b-lg shadow-sm">
          ...
          <div className="mb-8 bg-blue-50 p-4 rounded-lg">
            ...
            <a
              href="https://youtube.com/@i.de.afilms?si=zyOXDZ0NteiEuMpJ"
              target="_blank"
            ...
            >
              <span className="text-gray-700 group-hover:text-blue-700">
                I.dE.Afilms - යූ ටියුබ් චැනල් එක සබ්ක්‍රයිබ් කරන්න (ඔයාලාගේ
                youtube වල main account වලින් විතරක් subcribe කරන්න 100
                Subscribe වෙනකම් 1 screenshot එකක් upload කරන්න)
              </span>
